...
size_t difficultyBlocksCountByBlockVersion(uint8_t blockMajorVersion, uint32_t height) const {
  ...
  uint64_t getNextDifficulty(uint8_t blockMajorVersion, uint32_t blockIndex, std::vector<uint64_t> timestamps, std::vector<uint64_t> cumulativeDifficulties) const;
  uint64_t nextDifficultyDefault(std::vector<uint64_t> timestamps, std::vector<uint64_t> cumulativeDifficulties) const;
  uint64_t nextDifficultyV1(uint8_t blockMajorVersion, uint32_t blockIndex, std::vector<uint64_t> timestamps, std::vector<uint64_t> cumulativeDifficulties) const;
  uint64_t nextDifficultyV2(uint8_t blockMajorVersion, uint32_t blockIndex, std::vector<uint64_t> timestamps, std::vector<uint64_t> cumulativeDifficulties) const;
  uint64_t nextDifficultyV3(uint8_t blockMajorVersion, uint32_t blockIndex, std::vector<uint64_t> timestamps, std::vector<uint64_t> cumulativeDifficulties) const;
